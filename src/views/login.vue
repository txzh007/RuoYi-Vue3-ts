<template>
    <div class="login">
        <div class="login-panel">
            <h3 class="title">欢迎使用MetaRoad+</h3>
            ...
            <div style="color:#999999;font-size: 12px; text-align: center">一一一一一一一一一 第三方登录 一一一一一一一一一</div>

            <div>
                <img src="@/assets/images/login_wechat.png" alt="">
            </div>
        </div>
        <!--  底部  -->
